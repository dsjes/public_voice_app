...
oid sha256:398236ca475cd6f895ead7532b5deca380f9bebaf0480aa72a7e6576823e195f
size 12207
=======
import pandas as pd
...
def selectbox(brand,title,title1,title2):
    if brand == "大碩":
        ...
        with col1:
            option_競品1 = st.selectbox(f"{title}:**{brand}**，{title1}:",("大碩",'偉文', '高點',"不選擇"))
        with col2:
            option_競品2 = st.selectbox(f"{title}:**{brand}**，{title2}:",("大碩",'偉文', '高點',"不選擇"))
    elif brand == "洋碩":
        col1, col2 = st.columns(2)
        with col1:
            option_競品1 = st.selectbox(f"{title}:**{brand}**，{title1}:",("洋碩",'巨匠',"菁英","字神帝國","不選擇"))
        with col2:
            option_競品2 = st.selectbox(f"{title}:**{brand}**，{title2}:",("洋碩",'巨匠',"菁英","字神帝國","不選擇"))
    elif brand == "百官":
        col1, col2 = st.columns(2)
        with col1:
            option_競品1 = st.selectbox(f"{title}:**{brand}**，{title1}:",("百官",'志光',"三民","公職王","不選擇"))
        with col2:
            option_競品2 = st.selectbox(f"{title}:**{brand}**，{title2}:",("百官",'志光',"三民","公職王","不選擇"))
    elif brand == "放洋":
        col1, col2 = st.columns(2)
        with col1:
            option_競品1 = st.selectbox(f"{title}:**{brand}**，{title1}:",("放洋",'留學家',"不選擇"))
        with col2:
            option_競品2 = st.selectbox(f"{title}:**{brand}**，{title2}:",("放洋",'留學家',"不選擇"))
    elif brand == "甄戰":
        col1, col2 = st.columns(2)
        with col1:
            option_競品1 = st.selectbox(f"{title}:**{brand}**，{title1}:",("甄戰",'樂學網',"不選擇"))
        with col2:
            option_競品2 = st.selectbox(f"{title}:**{brand}**，{title2}:",("甄戰",'樂學網',"不選擇"))
    elif brand == "龍門":
        col1, col2 = st.columns(2)
        with col1:
            option_競品1 = st.selectbox(f"{title}:**{brand}**，{title1}:",("龍門",'高點',"偉文","不選擇"))
        with col2:
            option_競品2 = st.selectbox(f"{title}:**{brand}**，{title2}:",("龍門",'高點',"偉文","不選擇"))
